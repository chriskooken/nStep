...
namespace Spart.Parsers
{
	...
	public class Ops
	{
		...
		/// <param name="parser"></param>
		/// <returns></returns>
		public static RepetitionParser Not(Parser parser)
		{
			if (parser == null)
				throw new ArgumentNullException("parser is null");
			return new RepetitionParser(parser, 0, 0);
		}


		public static RepetitionParser Not(char c)
		{
			return Positive(Prims.Ch(c));
		}


		public static RepetitionParser Not(String s)
		{

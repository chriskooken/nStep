...
/// 9/16/2009: Modified by Adam Moss
...
namespace Spart.Parsers
{
	...
	public class Prims
	{
		...
		/// <summary>
		/// Creates a parser that matches an end of line
		/// </summary>
		...
		/// <summary>
		/// Creates a parser that matches the rest of line
		/// </summary>
		public static RolParser Rol
		{
			get
			{
				return new RolParser();
			}
		}
